...
public class ApiBaseAction {
    ...
    public Map<String, Object> bindException(Exception e) {
        if (e instanceof BindException) {
            return toResponseObject(1, "参数绑定异常", e.getMessage());
        } else if (e instanceof UnauthorizedException) {
            return toResponseObject(1, "无访问权限", e.getMessage());
        }
        return toResponseObject(1, "处理异常", e.getMessage());
    }
     ...
     * @author zhuliyun
     */
    public Map<String, Object> toResponseObject(int requestCode, String msg, Object data) {
